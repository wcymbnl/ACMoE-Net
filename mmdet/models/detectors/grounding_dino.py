...
class GroundingDINO(DINO):
    ...
    def __init__(self,
                 ...
                 lora_alpha=128, 
                 lora_dropout=0,
                 mogae_bottleneck=64,  #改
                 mogae_dropout=0.0,   #改
                 mogae_num_adapters=4,  #改
                 mogae_router_input_dim=None,  #改
                 mogae_router_type='sentence',  #改
                 mogae_adapter_scalar="learnable_scalar",  #改
                 mogae_adapter_layernorm_option="none",  #改
                 mogae_sparse=True,  #改
 ...
 ##############改#############               
            if use_mogae:
                self.lmm.model.build_mogae(
                    ...
                    router_input_dim=mogae_router_input_dim,
                    router_type=mogae_router_type,
                    sparse=mogae_sparse)  ##############改#############
