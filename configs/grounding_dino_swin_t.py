...
model = dict(
    ...
    lora_alpha=256, 
    lora_dropout=0,
    mogae_router_type='sentence',    #三种模型 T:token  I:'sentence'   IT:'sentence'
...
default_hooks = dict(
    checkpoint=dict(by_epoch=False, interval=1000, max_keep_ckpts=30),   #30000
